Suck-a-Coin version 0.3.1.0 is now available from:
...
- `6a3e798` Suck-a-Coin-Qt (Windows only): enable DEP for Suck-a-Coin-qt.exe
...
Miscellaneous:
- `fb66d3f` remove pre-Suck-a-Coin protocol versions
