Suck-a-Coin version 0.2.0.0 is now available from:
...
Suck-a-Coin data directory (listed below) and delete everything except the
wallet.dat and Suck-a-Coin.conf

Linux : ~/.Suck-a-Coin/

Windows : %appdata%\Roaming\Suck-a-Coin
...
- `62a3da1` Update GitHub URLs to point to Suck-a-CoinFoundation/Suck-a-Coin
...
- `19ca0ef` Point GitHub URL to Suck-a-CoinFoundation
