...
// for both Suck-a-Coind and Suck-a-Coin(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of Suck-a-Coin releases, the client name should be selected from
